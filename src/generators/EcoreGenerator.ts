...
export function generateEcore(model: VModel, filePath: string, destination: string | undefined): string {
    ...
    fileNode.append("// automatically generated by Vmsc", NL, "//Please report any bug or improvement as an issues in https://github.com/othy1010/VMSC", NL, NL, '<?xml version="1.0" encoding="UTF-8"?>', NL);
